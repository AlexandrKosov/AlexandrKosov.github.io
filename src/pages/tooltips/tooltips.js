    ...
    render(){
        ...
        const custom = (
            <React.Fragment>
                <div style={{width: '450px'}}>
                    <h3>Заголовок подсказки <Badge variant="secondary">OK</Badge></h3>
                    <blockquote>
                        Надо стараться все делать хорошо. Плохо оно само получится...<cite>Андрей Миронов</cite>
                    </blockquote>
                    <p>Тултипы сделаны таким образом, что внутри может располагаться не только какой-то текст, а еще и react-компонент. 
                    То есть туда можно поместить разнообразную верстку.
                    Тултип автоматически рассчитывает, где ему "выпадать", сверху, или снизу. Четыре примера-кнопки по краям демонстрируют это.</p>
                </div>
            </React.Fragment>
        );
        ...
        return (
           <React.Fragment>
                ...
                Этот <Tooltip content={custom}><b>тултип</b></Tooltip> демонстрирует как раз кастомный контент выпадающей подсказки: заголовок, бейдж, цитату, автора цитаты. и кастомный текст.
